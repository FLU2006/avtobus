 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:EEC:M:SimpleDataObjects:v0.4.5}CodeListItemStartDate"/&gt;
 *         &lt;element ref="{urn:EEC:M:ComplexDataObjects:v0.4.5}StartLegalActDetails" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:EEC:M:SimpleDataObjects:v0.4.5}CodeListItemEndDate" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:EEC:M:ComplexDataObjects:v0.4.5}EndLegalActDetails" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CodeListItemDetailsV2Type {
    ...
    @XmlElement(name = "CodeListItemStartDate", namespace = "urn:EEC:M:SimpleDataObjects:v0.4.5", required = true)
    ...
    @XmlElement(name = "CodeListItemEndDate", namespace = "urn:EEC:M:SimpleDataObjects:v0.4.5")
    @XmlSchemaType(name = "date")
