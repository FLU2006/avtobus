 ...
 *       &lt;sequence&gt;
 *         &lt;element ref="{urn:EEC:M:SimpleDataObjects:v0.4.5}EDocErrorCode"/&gt;
 *         &lt;element ref="{urn:EEC:M:SimpleDataObjects:v0.4.5}EDocErrorText"/&gt;
 *         &lt;element ref="{urn:EEC:M:SimpleDataObjects:v0.4.5}EDocDetailedErrorText" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:EEC:M:SimpleDataObjects:v0.4.5}EDocElementText" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EDocErrorDetailsType {
    ...
    @XmlElement(name = "EDocErrorCode", namespace = "urn:EEC:M:SimpleDataObjects:v0.4.5", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    protected String eDocErrorCode;
    @XmlElement(name = "EDocErrorText", namespace = "urn:EEC:M:SimpleDataObjects:v0.4.5", required = true)
    protected String eDocErrorText;
    @XmlElement(name = "EDocDetailedErrorText", namespace = "urn:EEC:M:SimpleDataObjects:v0.4.5")
    protected String eDocDetailedErrorText;
    @XmlElement(name = "EDocElementText", namespace = "urn:EEC:M:SimpleDataObjects:v0.4.5")
